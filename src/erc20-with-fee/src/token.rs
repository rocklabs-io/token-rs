...
// fee settings
static mut UPDATE_FEE: u64 = 0; // fee for each update call
static mut QUERY_FEE: u64 = 0; // fee for each query call
static mut FEE_TO: Principal = Principal::anonymous(); // fee receiver
